...
class Ui_FlawFinderWidget(object):
    def setupUi(self, FlawFinderWidget):
        ...
        FlawFinderWidget.resize(664, 704)
        self.scrollArea = QtWidgets.QScrollArea(FlawFinderWidget)
        self.scrollArea.setGeometry(QtCore.QRect(10, 10, 641, 501))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 639, 499))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.te_flawfinder = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        self.te_flawfinder.setGeometry(QtCore.QRect(10, 10, 621, 481))
