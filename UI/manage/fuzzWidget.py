...
class Ui_Fuzz(object):
    def setupUi(self, Fuzz):
        ...
        Fuzz.resize(1327, 866)
        self.StringFuzzTableWidget = QtWidgets.QTableWidget(Fuzz)
        self.StringFuzzTableWidget.setGeometry(QtCore.QRect(30, 100, 361, 741))
...
"")
        ...
        self.StringFuzzTableWidget.setColumnCount(2)
        ...
        self.RunPushButton.setGeometry(QtCore.QRect(200, 30, 111, 41))
        self.RunPushButton.setObjectName("RunPushButton")
        self.IntFuzzTableWidget = QtWidgets.QTableWidget(Fuzz)
        self.IntFuzzTableWidget.setGeometry(QtCore.QRect(420, 100, 421, 741))
...
"")
        ...
        self.IntFuzzTableWidget.setColumnCount(2)
        ...
        self.ByteFuzzTableWidget.setGeometry(QtCore.QRect(870, 100, 421, 741))
...
"")
        ...
        self.ByteFuzzTableWidget.setColumnCount(2)
        ...
        self.comboBox.setGeometry(QtCore.QRect(70, 30, 121, 41))
