...
class Ui_ManageRiskFunction(object):
    def setupUi(self, ManageRiskFunction):
        ...
        self.AllRiskFuncTableWidget.setGeometry(QtCore.QRect(50, 120, 1231, 691))
        ...
        self.groupBox.setGeometry(QtCore.QRect(370, 50, 841, 41))
        ...
        self.DeletePushButton.setGeometry(QtCore.QRect(220, 50, 111, 41))
        self.DeletePushButton.setObjectName("DeletePushButton")
        self.AddPushButton = QtWidgets.QPushButton(ManageRiskFunction)
        self.AddPushButton.setGeometry(QtCore.QRect(80, 50, 111, 41))
