...
class Ui_ScanBuildWiget(object):
    def setupUi(self, ScanBuildWiget):
        ...
        ScanBuildWiget.resize(448, 609)
        self.scrollArea = QtWidgets.QScrollArea(ScanBuildWiget)
        self.scrollArea.setGeometry(QtCore.QRect(0, 30, 441, 281))
