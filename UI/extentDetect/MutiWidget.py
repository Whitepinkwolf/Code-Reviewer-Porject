...
class Ui_MutiWidget(object):
    def setupUi(self, MutiWidget):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(0, 60, 501, 541))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 499, 539))
...
"}")
        ...
        self.detectWidget.setGeometry(QtCore.QRect(520, 50, 501, 551))
        ...
        self.pb_detect_start.setGeometry(QtCore.QRect(120, 250, 251, 51))
        self.pb_detect_start.setStyleSheet("QPushButton::menu {\n"
"    font-size: 14px;\n"
"}")
        self.pb_detect_start.setObjectName("pb_detect_start")
        self.label_2 = QtWidgets.QLabel(self.tab_3)
        self.label_2.setGeometry(QtCore.QRect(50, 140, 401, 81))
...
"}")
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 10, 431, 41))
...
"}")
        ...
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(MutiWidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(740, 10, 271, 41))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.pb_generate_2 = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        self.pb_generate_2.setStyleSheet("QPushButton::menu {\n"
"    font-size: 13px;\n"
"}")
        self.pb_generate_2.setObjectName("pb_generate_2")
        self.horizontalLayout_2.addWidget(self.pb_generate_2)
        self.pb_download = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        self.pb_download.setStyleSheet("QPushButton::menu {\n"
"    font-size: 13px;\n"
"}")
    ...
    def retranslateUi(self, MutiWidget):
        ...
        self.label_2.setText(_translate("MutiWidget", "马上开始静态检测！"))
        ...
        self.pb_download.setText(_translate("MutiWidget", "下载"))
