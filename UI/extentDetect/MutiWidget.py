...
class Ui_MutiWidget(object):
    def setupUi(self, MutiWidget):
        ...
        MutiWidget.resize(1092, 795)
        self.scrollArea = QtWidgets.QScrollArea(MutiWidget)
        self.scrollArea.setGeometry(QtCore.QRect(0, 50, 501, 551))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 0, 431, 51))
        ...
        self.scrollArea_3.setGeometry(QtCore.QRect(0, 0, 1021, 161))
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName("scrollArea_3")
        self.scrollAreaWidgetContents_3 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1019, 159))
        self.scrollAreaWidgetContents_3.setObjectName("scrollAreaWidgetContents_3")
        self.te_cmd = CmdTextEdit(self.scrollAreaWidgetContents_3)
        self.te_cmd.setGeometry(QtCore.QRect(0, -4, 1021, 161))
        self.te_cmd.setObjectName("te_cmd")
        self.scrollArea_3.setWidget(self.scrollAreaWidgetContents_3)
        self.LogAndCmd.addTab(self.tab_2, "")
        self.pb_download = QtWidgets.QPushButton(MutiWidget)
        self.pb_download.setGeometry(QtCore.QRect(909, 10, 102, 28))
        self.pb_download.setObjectName("pb_download")
        self.pb_generate = QtWidgets.QPushButton(MutiWidget)
        self.pb_generate.setGeometry(QtCore.QRect(780, 10, 102, 28))
    ...
    def retranslateUi(self, MutiWidget):
        ...
        self.pb_generate.setText(_translate("MutiWidget", "生成审计报告"))
