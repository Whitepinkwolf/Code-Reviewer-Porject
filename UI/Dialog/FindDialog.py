...
class Ui_FindDialog(object):
    def setupUi(self, FindDialog):
        ...
        FindDialog.resize(587, 170)
        self.label = QtWidgets.QLabel(FindDialog)
        self.label.setGeometry(QtCore.QRect(10, 55, 81, 21))
        self.label.setObjectName("label")
        self.FindPushButton = QtWidgets.QPushButton(FindDialog)
        self.FindPushButton.setGeometry(QtCore.QRect(350, 50, 101, 31))
        ...
        self.FindLineEdit.setGeometry(QtCore.QRect(110, 50, 221, 31))
        self.FindLineEdit.setObjectName("FindLineEdit")
        self.FindNextPushButton = QtWidgets.QPushButton(FindDialog)
        self.FindNextPushButton.setGeometry(QtCore.QRect(470, 50, 93, 31))
